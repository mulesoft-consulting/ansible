...
def get_business_group_client_secret(module, bg_id, bg_client_id):
    ...
    resp_json = json.load(ap_common.execute_http_call('[get_business_group_client_secret]', module, my_url, 'GET', headers, None))
...
def get_organization(module, org_id):
    ...
    return_value = json.load(ap_common.execute_http_call('[get_organization]', module, my_url, 'GET', headers, None))
...
def get_me(module):
    ...
    return_value = json.load(ap_common.execute_http_call('[get_me]', module, my_url, 'GET', headers, None))
